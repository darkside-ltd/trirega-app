        ...
        <Disclosure as="nav" class="border-b border-indigo-300 border-opacity-25 bg-indigo-600 lg:border-none" v-slot="{ open }">
              ...
              <div class="flex items-center px-2 lg:px-0">
                ...
                <div class="hidden lg:ml-10 lg:block">
                  <div class="flex space-x-4">
                    ...
                    exact-path-active-class="test-class2 router-link-active bg-indigo-700 text-white"
          ...
          <DisclosurePanel class="lg:hidden">
            <div class="space-y-1 px-2 pb-3 pt-2">
              ...
              :aria-current="item.current ? 'page' : undefined"
              exact-active-class="bg-indigo-700 text-white"
              exact-path-active-class="bg-indigo-700 text-white"
              >
              {{ item.name }}</router-link>
            </div>
            <div class="border-t border-indigo-700 pb-3 pt-4">
              ...
              <div class="mt-3 space-y-1 px-2">
                <router-link v-for="item in userNavigation" :key="item.name" as="a" :to="item.href" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-indigo-500 hover:bg-opacity-75">{{ item.name }}</router-link>
              </div>
            </div>
          </DisclosurePanel>
        </Disclosure>
